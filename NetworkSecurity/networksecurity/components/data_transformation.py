...
from networksecurity.entity.artifact_entity import DataTranformationArtifacts,DataValidationArtifacts
...
class DataTranformation:
    ...
    def initiate_data_transformation(self)->DataTranformationArtifacts:
        ...
        try:
            ...
            # preparing artifacts 
            data_transformation_artifact=DataTranformationArtifacts(
